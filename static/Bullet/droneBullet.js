function NecroDroneBullet(radius, rotate) {
  "use strict";
  ...
  this.setCanvasSize = function(camera) {
    ...
    this.canvasPos = {
      x: (this.radius * 2 * camera.z) + xx,
      y: (this.radius * 2 * camera.z) + yy
    };
...
NecroDroneBullet.prototype = new DynamicObject();
NecroDroneBullet.prototype.constructor = NecroDroneBullet;